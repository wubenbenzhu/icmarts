...
else
{
    ...
    else
    {
        ...
        if (!empty($_GET['uri']))
        {
            ...
            $uri = (strpos($_GET['uri'], 'http://') === false && strpos($_GET['uri'], 'https://') === false) ? $_SERVER['HTTP_REFERER'] . urldecode($_GET['uri']) : urldecode($_GET['uri']);

         
            if(strpos($ad_info['ad_link'], 'http://') )
            {
            
            }else
            {
            	$ad_info['ad_link'] = $ad_info['ad_link'];
            }
        }
        else
        {
